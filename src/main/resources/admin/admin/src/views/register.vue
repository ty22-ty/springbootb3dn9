  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(106, 0, 138, 0.47);borderRadius:10px">
        <h1 class="h1" style="color:rgba(251, 247, 247, 1);fontSize:28px;">学生毕业离校系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="职位" class="input" v-if="tableName=='xuesheng'">
			...
			<el-form-item label="政治面貌" class="input" v-if="tableName=='xuesheng'">
			  <el-input v-model="ruleForm.zhengzhimianmao" autocomplete="off" placeholder="政治面貌" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='xuesheng'" class="input-group">
			   <div class="label">获得奖项</div>
			   <div class="input-container">
			     <input v-model="ruleForm.huodejiangxiang" class="input" type="text" placeholder="获得奖项">
			   </div>
			 </div> -->
			<el-form-item label="获得奖项" class="input" v-if="tableName=='xuesheng'">
			  <el-input v-model="ruleForm.huodejiangxiang" autocomplete="off" placeholder="获得奖项" type="text" />
			</el-form-item>
