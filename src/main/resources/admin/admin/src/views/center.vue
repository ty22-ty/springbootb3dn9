     ...
     <el-row>
        ...
        <el-form-item   v-if="flag=='xuesheng'"  label="班级" prop="banji">
          <el-input v-model="ruleForm.banji"               placeholder="班级" clearable></el-input>
                        ...
                        <el-col :span="12">
        <el-form-item   v-if="flag=='xuesheng'"  label="职位" prop="zhiwei">
        ...
        <el-form-item   v-if="flag=='xuesheng'"  label="政治面貌" prop="zhengzhimianmao">
          <el-input v-model="ruleForm.zhengzhimianmao"               placeholder="政治面貌" clearable></el-input>
                        ...
                        <el-col :span="12">
        <el-form-item   v-if="flag=='xuesheng'"  label="获得奖项" prop="huodejiangxiang">
          <el-input v-model="ruleForm.huodejiangxiang"               placeholder="获得奖项" clearable></el-input>
        </el-form-item>
      </el-col>
                        <el-col :span="12">
