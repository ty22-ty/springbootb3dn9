          ...
          <el-form-item class="input" label="教师工号" prop="jiaoshigonghao">
              <el-input v-model="ruleForm.jiaoshigonghao" 
                placeholder="教师工号" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="论文选题" prop="lunwenxuanti">
          <el-input v-model="ruleForm.lunwenxuanti" 
              placeholder="论文选题" clearable  :readonly="ro.lunwenxuanti"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="论文选题" prop="lunwenxuanti">
              <el-input v-model="ruleForm.lunwenxuanti" 
                placeholder="论文选题" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.lunwen" label="论文" prop="lunwen">
            <el-button type="text" size="small" @click="download(ruleForm.lunwen)">下载</el-button>
                                                                                                ...
                                                                                                <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="答辩日期" prop="dabianriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.dabianriqi" 
                type="date"
                placeholder="答辩日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.dabianriqi" label="答辩日期" prop="dabianriqi">
              <el-input v-model="ruleForm.dabianriqi" 
                placeholder="答辩日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                                          </el-row>
                                                                                                            <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="查重报告" prop="chazhongbaogao">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="查重报告"
                  v-model="ruleForm.chazhongbaogao" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.chazhongbaogao" label="查重报告" prop="chazhongbaogao">
                    <span>{{ruleForm.chazhongbaogao}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
                                <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="论文答辩成绩" prop="lunwendabianchengji">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="论文答辩成绩"
                  v-model="ruleForm.lunwendabianchengji" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.lunwendabianchengji" label="论文答辩成绩" prop="lunwendabianchengji">
                    <span>{{ruleForm.lunwendabianchengji}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	lunwenxuanti : false,
	lunwen : false,
	chazhongbaogao : false,
	lunwendabianchengji : false,
	dabianriqi : false,
	sfsh : false,
	shhf : false,
      },
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jiaoshigonghao = true;
            continue;
	            	            ...
	            	            if(o=='lunwenxuanti'){
            this.ruleForm.lunwenxuanti = obj[o];
	    this.ro.lunwenxuanti = true;
            continue;
          }
	            	            if(o=='lunwen'){
	    ...
	    this.ro.lunwen = true;
            continue;
	            	            ...
	            	            if(o=='chazhongbaogao'){
            this.ruleForm.chazhongbaogao = obj[o];
	    this.ro.chazhongbaogao = true;
            continue;
          }
	            	            if(o=='lunwendabianchengji'){
            this.ruleForm.lunwendabianchengji = obj[o];
	    this.ro.lunwendabianchengji = true;
            continue;
          }
	            	            if(o=='dabianriqi'){
            this.ruleForm.dabianriqi = obj[o];
	    this.ro.dabianriqi = true;
            continue;
          }
	            	            	                    }
                                                                                                                                                                                              }
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `lunwenshenhe/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.lunwenshenheCrossAddOrUpdateFlag = false;
                  this.parent.search();
