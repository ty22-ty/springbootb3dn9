          ...
          <el-form-item class="input" label="金额" prop="jine">
              <el-input v-model="ruleForm.jine" 
                placeholder="金额" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="明细" prop="mingxi">
          <el-input v-model="ruleForm.mingxi" 
              placeholder="明细" clearable  :readonly="ro.mingxi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="明细" prop="mingxi">
              <el-input v-model="ruleForm.mingxi" 
                placeholder="明细" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                            </el-row>
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `feiyongjiesuan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.feiyongjiesuanCrossAddOrUpdateFlag = false;
                  this.parent.search();
