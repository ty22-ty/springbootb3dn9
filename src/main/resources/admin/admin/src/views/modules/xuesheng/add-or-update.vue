          ...
          <el-form-item class="input" label="政治面貌" prop="zhengzhimianmao">
              <el-input v-model="ruleForm.zhengzhimianmao" 
                placeholder="政治面貌" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="获得奖项" prop="huodejiangxiang">
          <el-input v-model="ruleForm.huodejiangxiang" 
              placeholder="获得奖项" clearable  :readonly="ro.huodejiangxiang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="获得奖项" prop="huodejiangxiang">
              <el-input v-model="ruleForm.huodejiangxiang" 
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zhengzhimianmao = true;
            continue;
	            	            ...
	            	            if(o=='huodejiangxiang'){
            this.ruleForm.huodejiangxiang = obj[o];
	    this.ro.huodejiangxiang = true;
            continue;
          }
	            	            if(o=='jiaoshigonghao'){
